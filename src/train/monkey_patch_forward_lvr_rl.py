...
def qwen2_5_mixed_modality_forward_lvr_grpo(
    ...
    if position_ids is None and (attention_mask is None or attention_mask.ndim == 2):
        ...
        # get_rope_index lives on self.model (Qwen2_5_VLModel), not on the outer class.
        # Use keyword args to skip the second_per_grid_ts parameter added in newer transformers.
